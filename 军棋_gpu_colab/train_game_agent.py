...
# 确保模型保存的目录存在
MODEL_SAVE_PATH = "/content/drive/MyDrive/军棋/models/game_model.pth"
SETUP_MODEL_PATH = "/content/drive/MyDrive/军棋/models/setup_model.pth"
RED_MOVES_PATH = "/content/drive/MyDrive/军棋/models/red_moves.txt"
BLUE_MOVES_PATH = "/content/drive/MyDrive/军棋/models/blue_moves.txt"
FINAL_AGENT_RED_PATH = "/content/drive/MyDrive/军棋/models/game_agent_with_inference_model_red.pth"
FINAL_AGENT_BLUE_PATH = "/content/drive/MyDrive/军棋/models/game_agent_with_inference_model_blue.pth"
