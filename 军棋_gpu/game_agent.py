...
torch.save(trained_agent_red.qnetwork_local.state_dict(), '/code/军棋/models/game_agent_red.pth')
torch.save(trained_agent_blue.qnetwork_local.state_dict(), '/code/军棋/models/game_agent_blue.pth')
